using Strategy_Game.Controllers;
using System;
...
namespace Strategy_Game.Views
{
    public class Display
    {
        public void ShowMenu()
        {
            ...
            Console.WriteLine("1. All players with their resources.");
            Console.WriteLine("2. Result from last 5 battles.");
            Console.WriteLine("3. All buildings and units, avalable for faction \"Humans\".");
